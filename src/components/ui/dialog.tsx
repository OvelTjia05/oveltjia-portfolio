...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      ...
      {children}
      {/* <DialogPrimitive.Close className="absolute right-2 top-0 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
        <X className="h-6 w-6" />
